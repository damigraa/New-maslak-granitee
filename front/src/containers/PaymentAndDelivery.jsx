...
const Payment = ({ text }) => {
    return (
        <div className=" w-100 PaymentAndDelivery-block">
            ...
            <div className="my-3 w-100 PaymentAndDelivery-text">{text}
            </div>
        </div>
    )
...
const PaymentAndDelivery = () => {
    let paymentData = [
        {
            id: 1,
            text: "СОГЛАСОВАНИЕ ВАШЕГО ЗАКАЗА С МЕНЕДЖЕРОМ НАШЕЙ КОМПАНИИ."
        },
        {
            id: 2,
            text: "СОСТАВЛЕНИЕ И ПОДПИСАНИЕ ДОГОВОРА СО СПЕЦИФИКАЦИЕЙ ЗАКАЗА И УКАЗАННОЙ СУММОЙ."
        },
        {
            id: 3,
            text: "ВНЕСЕНИЕ ЗАКАЗЧИКОМ 50% СУММЫ.*"
        }, {
            id: 4,
            text: "СОГЛАСОВАНИЕ ВАШЕГО ЗАКАЗА С МЕНЕДЖЕРОМ НАШЕЙ КОМПАНИИ."
        },
        {
            id: 5,
            text: "ФОТО ОТЧЕТ МЕНЕДЖЕРА ЗАКАЗЧИКУ О ПРОДЕЛАННОЙ РАБОТЕ ПО ГОТОВНОСТИ ЗАКАЗА."
        },
        {
            id: 6,
            text: "СОГЛАСОВАНИЕ ВАШЕГО ЗАКАЗА С МЕНЕДЖЕРОМ НАШЕЙ КОМПАНИИ."
        ...
        {
            id: 7,
            text: "ОТПРАВКА ГРУЗА ВЫБРАННОЙ ЗАКАЗЧИКОМ ТРАНСПОРТНОЙ КОМПАНИЕЙ."
        },
    ]
    let paymentElement = paymentData.map((c) => (
        <Payment text={c.text} />
    ));
